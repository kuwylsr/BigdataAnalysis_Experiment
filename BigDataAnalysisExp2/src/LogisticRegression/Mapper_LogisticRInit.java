...
public class Mapper_LogisticRInit extends Mapper<LongWritable, Text, Text, Text>{
	...
	protected void setup(Mapper<LongWritable, Text, Text, Text>.Context context)
		...
		for(int i = 0 ; i<parameters.length;i++) { //为参数数组赋初值为 1
			parameters[i] = 1;
		}
	}
	@Override
	protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, Text, Text>.Context context)
		...
		double[] gradients = refreshGradients(parameters, xi, alpha, Double.parseDouble(classification)); //迭代更新参数数组
